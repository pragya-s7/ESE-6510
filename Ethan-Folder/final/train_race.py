...
local_rsl_path = project_root / "src" / "third_parties" / "rsl_rl_local"
if local_rsl_path.exists():
    local_rsl_path = str(local_rsl_path)
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    forward_progress_reward_scale = 75.0
    ...
    rewards = {
        ...
        'segment_velocity_reward_scale': segment_velocity_reward_scale,
        'cheat_reward_scale': cheat_reward,
